...
class Answer(models.Model):
    ...
    quest = models.ForeignKey(Question, on_delete=models.CASCADE, related_name='answers'),
    author = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
...
class TestAnswer(models.Model):
    ...
    voters = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='test_votes')
    author = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
