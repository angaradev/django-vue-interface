...
urlpatterns = [
    ...
    path('selectlistcarmodelnew/<int:pk>/', productApiViews.SelectNewProductModelsView.as_view(), name='api-select-carmodel-new-list'),
    path('selectlistcarengine/<int:pk>/', productApiViews.SelectFieldsEnginesView.as_view(), name='api-select-carengine-list'),
