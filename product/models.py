...
class ProductImage(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        imw, imh = im.size
        if imw > 1920:
            img_big = ImageOps.fit(im, (1920, 1280), method=method,
        ...
        # Rectangle 150x100
        img150 = ImageOps.fit(im, size[0], method=method,
                              bleed=0.0, centering=(0.5, 0.5))
        output = io.BytesIO()
        ...
        # Rectangle 150x150
        img150x150 = ImageOps.fit(im, (150,150), method=method,
                              bleed=0.0, centering=(0.5, 0.5))
        output = io.BytesIO()
        ...
        # Rectangle 245x164
        img245 = ImageOps.fit(im, size[1], method=method,
                              bleed=0.0, centering=(0.5, 0.5))
        output = io.BytesIO()
        ...
        # Square 245x245
        img245x245 = ImageOps.fit(im, (245, 245), method=method,
                              bleed=0.0, centering=(0.5, 0.5))
        output = io.BytesIO()
        ...
        # Rectangle 500x333
        img500 = ImageOps.fit(im, size[2], method=method,
                              bleed=0.0, centering=(0.5, 0.5))
        output = io.BytesIO()
        ...
        # Square 500x500
        img500x500 = ImageOps.fit(im, (500, 500), method=method,
                              bleed=0.0, centering=(0.5, 0.5))
        output = io.BytesIO()
        ...
        # Rectangle 900x600
        img800 = ImageOps.fit(im, size[3], method=method,
                              bleed=0.0, centering=(0.5, 0.5))
        output = io.BytesIO()
