...
urlpatterns = [
    ...
    path('category/<str:hierarchy>/',
         productviews.show_category, name='categories'),
    ...
    path('categorize-cats/', productviews.main_work_for_cats,
         name='categorizer-cats'),
    path('checkgroup/', productviews.check_group, name='checkgroup'),
    path('checkgroup-cat/', productviews.check_cat, name='checkgroup-cat'),
    path('categorizeeverything/', productviews.categorize_bulk,
         name='categorize-everything'),
    path('prod-list/<int:pk>/',
         productviews.ProductListViewForJs.as_view(), name='product-list-js'),

    path('find/',
         productviews.FindProductView.as_view(), name='fing-product'),
